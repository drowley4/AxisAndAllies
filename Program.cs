...
namespace AxisAndAllies
{
    class Program
    {
        ...
        {
            Dictionary<string,List<(Unit,int)>> ussrUnits = new Dictionary<string, List<(Unit, int)>>() {{"CAUCASUS",new List<(Unit, int)>(){(new Infantry(countries[0]),5)}},{"KARELIA S.S.R.",new List<(Unit, int)>(){(new Infantry(countries[0]),3),(new Armor(countries[0]),1),(new Fighter(countries[0]),1),(new AnitAircraft(countries[0]),1),(new IndustrialComplex(countries[0]),1)}},{"EVENKINATLOKRUG",new List<(Unit, int)>(){(new Infantry(countries[0]),2)}},{"RUSSIA",new List<(Unit, int)>(){(new Infantry(countries[0]),4),(new Armor(countries[0]),2),(new Fighter(countries[0]),1),(new AnitAircraft(countries[0]),1),(new IndustrialComplex(countries[0]),1)}},{"YAKUT S.S.R.",new List<(Unit, int)>(){(new Infantry(countries[0]),3)}},{"KARELIA COAST",new List<(Unit, int)>(){(new Transport(countries[0]),1),(new Submarine(countries[0]),1)}},{"SOVIET FAR EAST",new List<(Unit, int)>(){(new Infantry(countries[0]),2),(new Armor(countries[0]),1)}}};
            ...
            Dictionary<string,List<(Unit,int)>> germanyUnits = new Dictionary<string, List<(Unit, int)>>() {{"ALGERIA",new List<(Unit, int)>(){(new Infantry(countries[1]),1)}},{"LIBYA",new List<(Unit, int)>(){(new Infantry(countries[1]),1),(new Armor(countries[1]),1)}},{"WESTERN EUROPE",new List<(Unit, int)>(){(new Infantry(countries[1]),2),(new Armor(countries[1]),2),(new Fighter(countries[1]),1),(new AnitAircraft(countries[1]),1),(new IndustrialComplex(countries[1]),1)}},{"GERMANY",new List<(Unit, int)>(){(new Infantry(countries[1]),4),(new Armor(countries[1]),2),(new Fighter(countries[1]),1),(new Bomber(countries[1]),1),(new AnitAircraft(countries[1]),1),(new IndustrialComplex(countries[1]),1)}},{"SOUTHERN EUROPE",new List<(Unit, int)>(){(new Infantry(countries[1]),2),(new Armor(countries[1]),1),(new AnitAircraft(countries[1]),1),(new IndustrialComplex(countries[1]),1)}},{"EASTERN EUROPE",new List<(Unit, int)>(){(new Infantry(countries[1]),3),(new Armor(countries[1]),1),(new Fighter(countries[1]),1)}},{"UKRAINE",new List<(Unit, int)>(){(new Infantry(countries[1]),3),(new Armor(countries[1]),2),(new Fighter(countries[1]),1)}},{"FINLAND NORWAY",new List<(Unit, int)>(){(new Infantry(countries[1]),3),(new Armor(countries[1]),1),(new Fighter(countries[1]),1)}},{"SWEDEN COAST",new List<(Unit, int)>(){(new Transport(countries[1]),1),(new Submarine(countries[1]),1)}},{"NORTHEAST ALANTIC",new List<(Unit, int)>(){(new Submarine(countries[1]),1)}},{"ROME COAST",new List<(Unit, int)>(){(new Transport(countries[1]),1),(new Battleship(countries[1]),1)}}};
            ...
            Dictionary<string,List<(Unit,int)>> ukUnits = new Dictionary<string, List<(Unit, int)>>() {{"AUSTRALIA",new List<(Unit, int)>(){(new Infantry(countries[2]),2)}},{"SYRIA-IRAQ",new List<(Unit, int)>(){(new Infantry(countries[2]),1)}},{"UNION OF SOUTH AFRICA",new List<(Unit, int)>(){(new Infantry(countries[2]),1)}},{"ANGLO-EGYPT SUDAN",new List<(Unit, int)>(){(new Infantry(countries[2]),1),(new Armor(countries[2]),1)}},{"WESTERN CANADA",new List<(Unit, int)>(){(new Infantry(countries[2]),1)}},{"EASTERN CANADA",new List<(Unit, int)>(){(new Armor(countries[2]),1)}},{"INDIA",new List<(Unit, int)>(){(new Infantry(countries[2]),2),(new Fighter(countries[2]),1)}},{"UNITED KINGDOM",new List<(Unit, int)>(){(new Infantry(countries[2]),2),(new Armor(countries[2]),1),(new Fighter(countries[2]),2),(new Bomber(countries[2]),1),(new AnitAircraft(countries[2]),1),(new IndustrialComplex(countries[2]),1)}},{"UNITED KINGDOM COAST",new List<(Unit, int)>(){(new Transport(countries[2]),1),(new Battleship(countries[2]),1)}},{"EASTERN CANADA COAST",new List<(Unit, int)>(){(new Transport(countries[2]),1)}},{"INDIAN OCEAN",new List<(Unit, int)>(){(new Transport(countries[2]),1)}},{"GIBRALTAR COAST",new List<(Unit, int)>(){(new Battleship(countries[2]),1)}},{"SUEZ CANAL NORTH",new List<(Unit, int)>(){(new Submarine(countries[2]),1)}}};
            ...
            Dictionary<string,List<(Unit,int)>> japanUnits = new Dictionary<string, List<(Unit, int)>>() {{"KWANGTUNG",new List<(Unit, int)>(){(new Infantry(countries[3]),2)}},{"PHILIPPINE ISLANDS",new List<(Unit, int)>(){(new Infantry(countries[3]),2),(new Fighter(countries[3]),1)}},{"OKINAWA",new List<(Unit, int)>(){(new Infantry(countries[3]),1)}},{"WAKE ISLAND",new List<(Unit, int)>(){(new Infantry(countries[3]),1)}},{"CAROLINE ISLANDS",new List<(Unit, int)>(){(new Infantry(countries[3]),1)}},{"SOLOMON ISLANDS",new List<(Unit, int)>(){(new Infantry(countries[3]),1)}},{"NEW GUINEA",new List<(Unit, int)>(){(new Infantry(countries[3]),1)}},{"BORNEO CELEBES",new List<(Unit, int)>(){(new Infantry(countries[3]),1)}},{"EAST INDIES",new List<(Unit, int)>(){(new Infantry(countries[3]),1)}},{"FRENCH INDO-CHINA BURMA",new List<(Unit, int)>(){(new Infantry(countries[3]),2),(new Fighter(countries[3]),1)}},{"MANCHURIA",new List<(Unit, int)>(){(new Infantry(countries[3]),3),(new Fighter(countries[3]),1)}},{"JAPAN",new List<(Unit, int)>(){(new Infantry(countries[3]),3),(new Armor(countries[3]),1),(new Fighter(countries[3]),1),(new Bomber(countries[3]),1),(new AnitAircraft(countries[3]),1),(new IndustrialComplex(countries[3]),1)}},{"JAPAN COAST",new List<(Unit, int)>(){(new Transport(countries[3]),1),(new Battleship(countries[3]),1)}},{"PHILIPPINE ISLANDS COAST",new List<(Unit, int)>(){(new Transport(countries[3]),1)}},{"SOLOMON ISLANDS COAST",new List<(Unit, int)>(){(new Submarine(countries[3]),1)}},{"CAROLINE ISLANDS COAST",new List<(Unit, int)>(){(new Battleship(countries[3]),1),(new AircraftCarrier(countries[3]),1),(new Fighter(countries[3]),1)}}};
            ...
            Dictionary<string,List<(Unit,int)>> usUnits = new Dictionary<string, List<(Unit, int)>>() {{"ALASKA",new List<(Unit, int)>(){(new Infantry(countries[4]),1)}},{"MIDWAY ISLAND",new List<(Unit, int)>(){(new Infantry(countries[4]),1)}},{"HAWAIIAN ISLANDS",new List<(Unit, int)>(){(new Infantry(countries[4]),1)}},{"SINKIANG",new List<(Unit, int)>(){(new Infantry(countries[4]),2)}},{"CHINA",new List<(Unit, int)>(){(new Infantry(countries[4]),2),(new Fighter(countries[4]),1)}},{"WESTERN U.S.A.",new List<(Unit, int)>(){(new Infantry(countries[4]),2),(new Fighter(countries[4]),1),(new AnitAircraft(countries[4]),1),(new IndustrialComplex(countries[4]),1)}},{"EASTERN U.S.A.",new List<(Unit, int)>(){(new Infantry(countries[4]),2),(new Armor(countries[4]),1),(new Fighter(countries[4]),1),(new Bomber(countries[4]),1),(new AnitAircraft(countries[4]),1),(new IndustrialComplex(countries[4]),1)}},{"EASTERN U.S.A. COAST",new List<(Unit, int)>(){(new Transport(countries[4]),1)}},{"WESTERN U.S.A. COAST",new List<(Unit, int)>(){(new Transport(countries[4]),1),(new Battleship(countries[4]),1)}},{"HAWAIIAN ISLANDS COAST",new List<(Unit, int)>(){(new Battleship(countries[4]),1),(new AircraftCarrier(countries[4]),1),(new Fighter(countries[4]),1)}}};
